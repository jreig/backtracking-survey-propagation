...
// const float SATSolver::DEFAULT_EPSILON = 0.001f;
// const int SATSolver::DEFAULT_MAX_ITERATIONS = 10000;
// const int SATSolver::RANDOM_SEED = 0;
...
// //
// -----------------------------------------------------------------------------
// SATSolver::SATSolver(float epsilon, int maxIterations, int seed) {
//   // SP parameters
//   _epsilon = epsilon;
...
// BSPResult SATSolver::SID(const string& path) {
...
// BSPResult SATSolver::SP(FactorGraph* graph) {
...
// bool SATSolver::StoreFactorGraph(const string& path) {
...
// void SATSolver::InitSurveys(FactorGraph* graph) {
...
// void SATSolver::ShuffleEdgesOrder(FactorGraph* graph) {
//   vector<Edge*> edges = graph->GetEdges();
//   shuffle(edges.begin(), edges.end(), _randomGenerator);
// }

// void SATSolver::UpdateSurvey(Edge* ai) {
//   // Param edge is a->i
//   float Sai = 1.0f;
